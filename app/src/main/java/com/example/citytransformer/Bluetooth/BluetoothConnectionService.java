...
public class BluetoothConnectionService {
    private static BluetoothConnectionService connectionObj;
    private final String TAG = "BluetoothConnectionServ";
    ...
    public BluetoothConnectionService(Context context) {
        ...
        start();
        Log.e(TAG, "Bluetooth mcontext = context");
    }
    public static BluetoothConnectionService getInstance(Context context) {
        if(connectionObj == null) {
            connectionObj = new BluetoothConnectionService(context);
        }
    ...
    public void run() {
        ...
        while (true) {
            ...
            try {
                ...
                if (incomingMessage.equals("Unlock")) {
                    Log.e(TAG, "GET UNLOCK input message start intent");
                }
